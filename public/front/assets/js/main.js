...
$(document).ready(function($){
    ...
    var $d_details_main_slider;
    var $d_client_review_slider;
    var $upcomming_card_slider_1;
    var $upcomming_card_slider_2;
    var $upcomming_card_slider_3;
    var $client_slider;
    var $instagram_slider;
    var $blog_slider;
    ...
    loadThemeComponents=function () {
        ...
        ******************************************** */
        ...
        smSlider = $(".banner-slider").slick("getSlick");
        smSliderCount = smSlider.slideCount;
        ...
        /* -------------------------------------------------------------
               swiper-slider
           ------------------------------------------------------------- */
        swiper = new Swiper('.banner-slider-two', {
            mode:'horizontal',
            loop: true,
            autoHeight: true,
            speed: 950,
        ...
        /* -----------------------------------------------------
           ...
           ----------------------------------------------------- */
        $d_list_slider = $('.destinations-list-slider');
        $d_list_slider.slick({
            slidesToShow: 3,
            dots: false,
            slidesToScroll: 1,
        ...
        smSlider = $(".destinations-list-slider").slick("getSlick");
        smSliderCount = smSlider.slideCount;
        ...
        /* -----------------------------------------------------
                ...
                ----------------------------------------------------- */
        $d_details_main_slider = $('.destinations-details-main-slider');
        ...
        smSlider = $(".destinations-details-main-slider").slick("getSlick");
        smSliderCount = smSlider.slideCount;
        ...
        /* -----------------------------------------------------
            destination details main slider
        ----------------------------------------------------- */
        $d_client_review_slider = $('.destinations-client-review-slider');
        ...
        ----------------------------------------------------- */
        $upcomming_card_slider_1 = $('.upcomming-card-slider-1');
        ...
        ----------------------------------------------------- */
        $upcomming_card_slider_2 = $('.upcomming-card-slider-2');
        ...
        /* -----------------------------------------------------
            upcomming-card-slider-2
        ----------------------------------------------------- */
        $upcomming_card_slider_3 = $('.upcomming-card-slider-3');
        ...
        /* -----------------------------------------------------
            upcomming-card-slider-2
        ----------------------------------------------------- */
        $instagram_slider = $('.instagram-slider');
        ...
        /* -------------------------------------------------------------
            swiper-slider
        ------------------------------------------------------------- */
        swiper = new Swiper('.client-slider-two', {
            mode:'horizontal',
            loop: true,
            speed: 950,
            effect: 'coverflow',
    ...
    addToCallAtLoadArr("loadThemeComponents");
