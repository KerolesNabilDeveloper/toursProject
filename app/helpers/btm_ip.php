...
function get_client_ip($changeLocalIp = true)
{
    $ipaddress = '';
    ...
    if (in_array($ipaddress, ["127.0.0.1", "::1"]) && $changeLocalIp) {
        //egypt
        $ipaddress = "197.163.87.0";
    }
...
function getIpPhoneCode(){
    ...
    return $ip_data["location"]["calling_code"] ?? "";
