...
class CreateOnlinePaymentTransactionsLogTable extends Migration {
	...
	public function up()
	{
	    ...
	    if (Schema::hasTable('online_payment_transactions_log')) {
            return;
        }

		Schema::create('online_payment_transactions_log', function(Blueprint $table)
		{
	...
	{
		Schema::drop('online_payment_transactions_log');
	}
